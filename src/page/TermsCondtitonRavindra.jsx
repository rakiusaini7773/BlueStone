  ...
  return (
    <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-lg p-8">
      ...
      <ol className="list-decimal list-inside space-y-4 text-gray-700">
        ...
        <li>
          This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <a href="https://www.zaveristone.shop/" className="font-bold text-blue-500 hover:underline">https://www.zaveristone.shop/</a> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </li>
        <li>
          The Platform is owned by <strong className="font-bold">zaveristone</strong>, a company incorporated under the Companies Act, 1956 with its registered office at NO 15, 107, JAYANAGAR WEST, 4th Cross, 7th Block, Bengaluru, Bengaluru Urban, Karnataka, 560070, Bangalore, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
        </li>
        <li>
        ...
        <li>
          ...
          <ol className="list-decimal list-inside space-y-4">
            ...
            <li>
              All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website according to the terms and condition.
            </li>
          </ol>
        </li>
      </ol>
