  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li>
          This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.<strong className="font-bold">zaveristone</strong>.shop/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </li>
        <li>
