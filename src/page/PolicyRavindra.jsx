...
const PolicyComponent = () => {
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
                All orders are non-refundable, unless stated otherwise. In case you receive a defective product, you may contact us to initiate the return process. Refunds will be processed within 7-10 business days after we receive the returned product.
            </p>

            <h1 className="text-3xl font-bold mb-6">Return Policy</h1>
            <p className="text-gray-700 leading-relaxed mb-4">
                Our return policy lasts for 30 days. If 30 days have passed since your purchase, we cannot offer you a refund or exchange. To be eligible for a return, your item must be unused and in the same condition that you received it. It must also be in the original packaging.
            </p>

            <h1 className="text-3xl font-bold mb-6">Shipping Policy</h1>
            <p className="text-gray-700 leading-relaxed mb-4">
                Shipping costs are non-refundable. If you receive a refund, the cost of return shipping will be deducted from your refund. We ship to the address you provide during checkout, and we are not responsible for any delays caused by the carrier.
            </p>
        </div>
    );
};
